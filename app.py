...
<div class="main-header">
    ...
    <p>Tác giả: Hà Kim Thuần - Trường PTDTBT Tiểu học Ngam La - ĐT: 085 8488 161</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Kim Thuần - Trường PTDTBT Tiểu học Ngam La - ĐT: 085 8488 161</div>", unsafe_allow_html=True)
